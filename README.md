...
class Habilidades extends Desenvolvedor {
  linguagensDesenvolvimento = ["JavaScript", "TypeScript", "C#", "C++", "Node.JS", "PHP", "React.JS", "Python", "Swift"];
...
[<img align="left" height="80px" width="95px" alt="Warpnet" src="https://s3saude.org.br/wp-content/uploads/2021/02/Logo-s3-saude.png"/>](https://s3saude.org.br/)

**Software Engineer** \
[**S3**](https://s3saude.org.br/) • Tempo total \
